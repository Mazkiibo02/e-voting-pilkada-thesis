...
app.use('/uploads', express.static(path.join(__dirname, '../uploads/candidates')));
app.use('/api/uploads', express.static(path.join(__dirname, '../uploads')));
app.use('/api/uploads', express.static(path.join(__dirname, '../uploads/candidates')));
...
app.use("/api/candidate-pairs", candidatePairsRoutes);
app.use("/voting-sessions", votingSessionsRoutes);
app.use("/api/voting-sessions", votingSessionsRoutes);
